...
2. The article ids are autogenerated within the implementation.
3. The package relies on a mix of OOB Go Unit Testing and Postman for testing the solution.
4. Bigcache was chosen among bigcache, freecache and map. This was on the past experience with bigcache and freecache.
5. spf13/viper is used to read the config yamls.
